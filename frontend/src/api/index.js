...
export const purchasingApi = {
  ...
  getRFQ: (params) => api.get('/purchasing/rfq', { params }),
  createRFQ: (data) => api.post('/purchasing/rfq', data),
  deleteRFQ: (id) => api.delete(`/purchasing/rfq/${id}`),
  sendRFQ: (id, data) => api.post(`/purchasing/rfq/${id}/send`, data),
  getRFQVendors: (id) => api.get(`/purchasing/rfq/${id}/vendors`),
  getRFQOffers: (id) => api.get(`/purchasing/rfq/${id}/offers`),
  submitRFQOffer: (id, data) => api.post(`/purchasing/rfq/${id}/offers`, data),
  selectRFQWinner: (id, data) => api.post(`/purchasing/rfq/${id}/select-winner`, data),
}
...
export const approvalApi = {
  ...
  action: (id, data) => api.patch(`/approvals/${id}/action`, data),
  getRules: (params) => api.get('/approvals/rules', { params }),
