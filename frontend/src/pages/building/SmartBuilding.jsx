...
const VALID_TABS = ['overview', 'hvac', 'energy']
const SECTION_TITLE = { overview: 'Overview', hvac: 'HVAC', energy: 'Energi' }
...
export default function SmartBuilding() {
  ...
  useEffect(() => {
    if (!VALID_TABS.includes(tab)) navigate('/building/overview', { replace: true })
  }, [tab])
