...
const TABS = [
  ...
  { id: 'comparative', label: 'Perbandingan' },
]
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {activeTab === 'coa' && <Button size="sm" icon={<Plus />} onClick={() => setShowCOAModal(true)}>Tambah Akun</Button>}
        {activeTab === 'journal' && <Button size="sm" icon={<Plus />} onClick={() => setShowJEModal(true)}>Buat Jurnal</Button>}
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              searchPlaceholder="Cari ref, keterangan..."
              defaultPageSize={10}
              toolbar={<Button size="sm" icon={<Plus />} onClick={() => setShowJEModal(true)}>Buat Jurnal</Button>}
            />
          </CardContent>
        </Card>
      )}
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              defaultPageSize={20}
              toolbar={<Button size="sm" icon={<Plus />} onClick={() => setShowCOAModal(true)}>Tambah Akun</Button>}
            />
          </CardContent>
        </Card>
      )}
