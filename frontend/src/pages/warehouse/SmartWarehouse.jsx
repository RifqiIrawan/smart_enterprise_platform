...
export default function SmartWarehouse() {
  ...
  const tabs = [
    ...
    { id: 'movements', label: 'Mutasi' },
    { id: 'alerts', label: 'Reorder Alert', count: alerts.length > 0 ? alerts.length : undefined },
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          {activeTab === 'inventory' && (
            <>
              <Button variant="secondary" size="sm" icon={<MoveRight />} onClick={() => setShowTransferModal(true)}>Transfer</Button>
              <Button size="sm" icon={<Plus />} onClick={() => { setEditRow(null); setItemForm(emptyItem); setShowItemModal(true) }}>Tambah Item</Button>
            </>
          )}
          {activeTab === 'movements' && (
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              defaultPageSize={10}
              toolbar={<Button size="sm" icon={<Plus />} onClick={() => { setEditRow(null); setItemForm(emptyItem); setShowItemModal(true) }}>Tambah Item</Button>}
              actions={(row) => (
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              defaultPageSize={10}
              toolbar={<Button size="sm" icon={<Plus />} onClick={() => setShowMoveModal(true)}>Catat Mutasi</Button>}
            />
          </CardContent>
        </Card>
      )}
