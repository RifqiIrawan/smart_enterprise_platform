...
const TABS = [
  { id: 'master', label: 'Master Anggaran' },
  { id: 'vsactual', label: 'Budget vs Aktual' },
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {activeTab === 'master' && (
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button size="sm" variant="secondary" icon={<Upload className="w-4 h-4" />} onClick={() => importRef.current?.click()}>Import CSV</Button>
            <Button size="sm" icon={<Plus />} onClick={() => { setEditEntry(null); setEntryForm(emptyEntry); setShowModal(true) }}>Tambah Anggaran</Button>
          </div>
        )}
        {activeTab === 'scenarios' && (
