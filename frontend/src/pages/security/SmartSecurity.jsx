    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex gap-1 bg-gray-100 p-1 rounded-lg">
          {[{ id: 'visitor', label: 'Tamu' }, { id: 'incident', label: 'Insiden' }, { id: 'access', label: 'Akses Pintu' }].map((t) => (
        ...
        <Button size="sm" icon={<Plus />} onClick={() => setShowModal(true)}>
          {activeTab === 'visitor' ? 'Check-in Tamu' : 'Laporkan Insiden'}
        </Button>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              defaultPageSize={10}
              toolbar={<Button size="sm" icon={<Plus />} onClick={() => setShowModal(true)}>Check-in Tamu</Button>}
        ...
        <Card>
          ...
          <CardContent>
            <DataTable
              ...
              defaultPageSize={10}
              toolbar={<Button size="sm" icon={<Plus />} onClick={() => setShowModal(true)}>Laporkan Insiden</Button>}
            />
          </CardContent>
        </Card>
      )}
