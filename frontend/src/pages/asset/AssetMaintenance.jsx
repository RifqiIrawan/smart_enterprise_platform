...
const TABS = [
  ...
  { id: 'maintenance', label: 'Jadwal Maintenance' },
  { id: 'pm', label: 'PM Schedule' },
  { id: 'spareparts', label: 'Spare Parts' },
  { id: 'depreciation', label: 'Depresiasi & Disposal' },
]
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {['assets', 'maintenance', 'pm', 'spareparts'].includes(activeTab) && (
        ...
        <Card>
          ...
          <CardContent>
            <DataTable ref={assetRef} columns={assetColumns} fetchFn={assetApi.getAssets}
              ...
              toolbar={<Button size="sm" icon={<Plus />} onClick={openModal}>Tambah Aset</Button>}
              actions={(row) => (
                <div className="flex gap-1">
                  <button onClick={() => openEditAsset(row)} className="flex items-center gap-1 px-2 py-1 text-xs rounded-lg text-blue-600 hover:bg-blue-50 transition-colors font-medium"><Pencil className="w-3.5 h-3.5" /> Edit</button>
                  <button onClick={() => setDeleteItem(row)} className="flex items-center gap-1 px-2 py-1 text-xs rounded-lg text-red-500 hover:bg-red-50 transition-colors font-medium"><Trash2 className="w-3.5 h-3.5" /> Hapus</button>
                </div>
              )}
            />
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <DataTable ref={maintRef} columns={maintColumns} fetchFn={assetApi.getMaintenance}
              ...
              toolbar={<Button size="sm" icon={<Plus />} onClick={openModal}>Buat Jadwal</Button>}
              actions={(row) => row.status !== 'done' && (
        ...
        <Card>
          ...
          <CardContent>
            <DataTable ref={pmRef} columns={pmColumns} fetchFn={assetApi.getPMSchedules}
              ...
              toolbar={<Button size="sm" icon={<Plus />} onClick={openModal}>Tambah PM</Button>}
              actions={(row) => (
                <div className="flex gap-1">
                  {row.status !== 'done' && (
        ...
        <Card>
          ...
          <CardContent>
            <DataTable ref={spRef} columns={spColumns} fetchFn={assetApi.getSpareParts}
              ...
              toolbar={<Button size="sm" icon={<Plus />} onClick={openModal}>Tambah Part</Button>}
              actions={(row) => (
                <div className="flex gap-1">
                  <button onClick={() => openEditSP(row)} className="flex items-center gap-1 px-2 py-1 text-xs rounded-lg text-blue-600 hover:bg-blue-50 transition-colors font-medium"><Pencil className="w-3.5 h-3.5" /> Edit</button>
                  <button onClick={() => handleDeleteSP(row)} className="flex items-center gap-1 px-2 py-1 text-xs rounded-lg text-red-500 hover:bg-red-50 transition-colors font-medium"><Trash2 className="w-3.5 h-3.5" /> Hapus</button>
                </div>
              )}
            />
          </CardContent>
